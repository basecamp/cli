...
# Library release — no GoReleaser, no binary builds.
# Tagged Go modules are published via the module proxy automatically.
...
echo ""
echo "  Actions: https://github.com/basecamp/cli/actions"
echo "  Module:  https://pkg.go.dev/github.com/basecamp/cli@${TAG}"
